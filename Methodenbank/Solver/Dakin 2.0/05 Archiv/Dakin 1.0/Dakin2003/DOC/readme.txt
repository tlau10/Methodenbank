...
Vorgehensweise:
Zunächst muss das Verzeichnis komplett in das Verzeichnis EXEC des Dakin-Solvers auf Neptun 
kopiert werden. 
Außerdem sollte das Verzeichnis src in das Verzeichnis SOURCE des Dakin-Solvers auf Neptun
kopiert werden.



Zu beachten:
Beim Programmstart müssen zusätzlich noch die beiden Jar-Files
