...
public class SolverDaten implements Serializable {
	...
	// bergibt das Budget fr die Fernsehanstalten
	...
	// bergibt die Anzahl Fernsehanstalten
	...
	// einem Array bergeben und den entsprechenden Variablen
	// zugeordnet
	...
	public void setSolverInput() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Kann Solver.bat nicht ausfuehren. Exit 1", "Fehler",
