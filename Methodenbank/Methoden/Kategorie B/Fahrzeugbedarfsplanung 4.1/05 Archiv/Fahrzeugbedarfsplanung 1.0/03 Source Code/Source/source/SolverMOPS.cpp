...
//********************************************************************************
	...
	fprintf( streamStart, "@echo off\n");
	fprintf( streamStart, "REM Solver: MOPS Win32-Version\n");
	fprintf( streamStart, "c:\n");
	fprintf( streamStart, "cd\\\n");
	fprintf( streamStart, "cd temp\\\n");
	fprintf( streamStart, "path c:\\temp\\\n");
