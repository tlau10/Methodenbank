 ...
 *       &lt;sequence>
 *         &lt;element ref="{}resultColumn" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "resultColumns")
public class ResultColumns {

    @XmlElement(required = true)
    protected List<ResultColumn> resultColumn;
     ...
     * 
     */
    public List<ResultColumn> getResultColumn() {
        if (resultColumn == null) {
            resultColumn = new ArrayList<ResultColumn>();
        }
