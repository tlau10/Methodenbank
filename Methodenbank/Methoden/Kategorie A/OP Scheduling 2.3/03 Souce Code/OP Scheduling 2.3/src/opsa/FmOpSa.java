...
public class FmOpSa extends JFrame {
	...
	void buttonOpt_actionPerformed(ActionEvent e) {
		if (tbOpModel.getRowCount() == 0) {
			JOptionPane.showMessageDialog(this,"Bitte wählen Sie Neu im Menü aus.", "Info",	JOptionPane.INFORMATION_MESSAGE);
			return;
		}
		if (tbOpModel.getValueAt(tbOpModel.getRowCount() - 1, tbOpModel.getColumnCount() - 2) == null) {
			JOptionPane.showMessageDialog(this,"Bitte geben Sie Daten in die Tabelle Operation ein.","Info", JOptionPane.INFORMATION_MESSAGE);
			return;
		}
		...
		if (this.setOperations() == true) {
			...
			if (theLpdata != null) {
				...
				//Set Ini if Changed
				theLpdata.setLPSolvePath(ini.getCheckedPath());
	...
	private void jbInit() throws Exception {
		...
		this.setTitle("OP-Scheduling 2.3");
		jMenuFile.setText("Datei");
		jMenuOption.setText("Einstellungen");
		...
		jMenuHelp.setText("Über");
		jMenuHelpAbout.setText("Analysebericht");
		...
		jMenuItemPath.setText("Solverpfad");
...
//		dlg.show();
		...
		frame.setTitle("OP Scheduling 2.3 - Analysebericht");
	...
	void jMenuItemOpen_actionPerformed(ActionEvent e) {
		...
		//f.setFile(".opsa");
		f.setDirectory("C:\\Methodenbank\\Methoden\\Kategorie A\\OP Scheduling 2.3\\01 Programm\\daten");
	...
	void jMenuItemPath_actionPerformed(ActionEvent e) {
		...
		framePathOption.setSize(600, 150);
