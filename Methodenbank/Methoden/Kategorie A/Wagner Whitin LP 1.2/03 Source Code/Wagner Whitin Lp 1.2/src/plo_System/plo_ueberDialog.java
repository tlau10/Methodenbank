...
public class plo_ueberDialog extends JDialog
{
	...
	private JLabel überLabel11;
	private JLabel überLabel12;
...
//*** Konstruktor ***************************************************************
	public plo_ueberDialog()
	{
		...
		überLabel2 = new JLabel("(Version 1.2)");
		überLabel3 = new JLabel("(c) 2016 ");
		überLabel4 = new JLabel("---------------------------------------------------------------------- ");
		überLabel5 = new JLabel("Programmiert von:");
		überLabel6 = new JLabel("Marco Weiß (2016)");
		überLabel7 = new JLabel("Jenne Justin (2016)");
		überLabel8 = new JLabel("Eugen Gering (2015/16)");
		überLabel9 = new JLabel("Melisa Gündüz (2015/16)");
		überLabel10 = new JLabel("Francis Göltner (2001/02)");
		überLabel11 = new JLabel("Helmut Lindinger (2001/02)");
		überLabel12 = new JLabel("Bernd Saile (2001/02)");
		...
		this.buildConstraints(überGridBagConstraints, überLabel11, 0, 10, 1, 1, GridBagConstraints.NONE, GridBagConstraints.CENTER, 0, 0, new Insets(5,0,5,0));
		this.buildConstraints(überGridBagConstraints, überLabel12, 0, 11, 1, 1, GridBagConstraints.NONE, GridBagConstraints.CENTER, 0, 0, new Insets(5,0,5,0));
		...
		überPanel.add(überLabel11);
		überPanel.add(überLabel12);
