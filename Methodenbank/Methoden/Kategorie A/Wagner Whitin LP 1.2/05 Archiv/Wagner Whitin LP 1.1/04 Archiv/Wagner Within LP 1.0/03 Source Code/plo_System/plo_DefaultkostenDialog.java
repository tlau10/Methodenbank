...
//*		in welchem die Standartwerte für Bestell- und Lager-		*
//*		kosten zur Laufzeit verändert werden können					*
//*																	*
//*		Version: 1.0												*
//*																	*
//*******************************************************************
...
{
	private plo_DefaultkostenDialog ref;								//Referenzobjekt für den Aufruf von dispose()
...
//*** Konstruktor ***------------------------------------------------------
	public plo_DefaultkostenDialog(plo_Hauptfenster base)
	{
		...
		this.buildConstraints(d_DefaultkostenGridBagConstraints, bestellkostenLabel, 0, 1, 2, 1, GridBagConstraints.NONE, GridBagConstraints.WEST, 0, 0, new Insets(5,0,5,0));	//für die Darstellungskomponenten
		...
		defaultkostenPanel.setLayout(d_DefaultkostenGridBagLayout);		//Hinzufügen der Komponente
		...
		ActionListener plo_DefkostDiaListener = new ActionListener()	//Definition des Listeners für
		{																//Knopfdrücke
			public void actionPerformed(ActionEvent aevt)				//
			{															//
				JButton compare = new JButton();						//Feststellen, welcher Button degrückt
		...
		{																//
			...
			{															//
				...
				compare = (JButton)focevt.getSource();					//verändert wurde
		...
		jb_Ok.addActionListener(plo_DefkostDiaListener);				//Verbinden von Schaltflächen und
		...
		defaultkostenPanel.add(dialogFrame);							//Hinzufügen des Darstellungsframes zum Dialog
...
//*** GET-Methoden ***-----------------------------------------------------
	public String getTf_BestellkostenText()								//Methode zur Rückgabe des Inhalts des Textfelds Bestellkosten
	{
		return tf_Bestellkosten.getText();
	}

	public String getTf_LagerkostenText()								//Methode zur Rückgabe des Inhalts des Textfelds Lagerkosten
	{
