...
//*		zur Änderung von Solvername, -pfad und Arbeits-				*
//*		verzeichnis													*
//*																	*
//*		Version: 1.0												*
//*																	*
...
public class plo_SolverDatenDialog extends JDialog
{
	...
	private JButton jb_Ok;												//Schaltflächen
	private JButton jb_Abbrechen;										//
	private boolean jb_Ok_Focus;										//Indikatorvariablen für den Fokusstatus
...
//*** Konstruktor ***------------------------------------------------------
	public plo_SolverDatenDialog(plo_Hauptfenster base)
	{
		...
		this.buildConstraints(d_SolverDatenGridBagConstraints, arbeitsverzeichnisLabel, 0, 1, 2, 1, GridBagConstraints.NONE, GridBagConstraints.WEST, 0, 0, new Insets(5,0,5,0));	//für die Darstellungskomponenten
		...
		solverDatenPanel.setLayout(d_SolverDatenGridBagLayout);			//Hinzufügen der Komponenten
		...
		ActionListener plo_SolverDatenDiaListener = new ActionListener()//Listener für
		{																//Klicks auf die Schaltfläche
			public void actionPerformed(ActionEvent aevt)				//
			{															//
				JButton compare = new JButton();						//Feststellen, welche Schaltfläche geklickt wurde
		...
		FocusListener plo_SolverDatenDiaFocListener = new FocusListener()	//Listenerdefinition für Fokusänderungen
		{																//
		...
		{																//
			...
			{															//
				int compare = kevt.getKeyCode();						//Ist die Taste "ENTER" gedrückt worden
		...
		jb_Ok.addActionListener(plo_SolverDatenDiaListener);				//Hinzufügen der Listener zu
		...
		solverDatenPanel.add(dialogFrame);								//Hinzufügen des Frames
...
//*** GET-Methoden ***-----------------------------------------------------
	public String getTf_ArbeitsverzeichnisText()								//Methode zur Rückgabe des Inhalts des Textfelds Bestellkosten
	{
		return tf_Arbeitsverzeichnis.getText();
	}

	public String getTf_SolverNameText()										//Methode zur Rückgabe des Inhalts des Textfelds Lagerkosten
	{
		return tf_SolverName.getText();
	}

	public String getTf_SolverPfadText()										//Methode zur Rückgabe des Inhalts des Textfelds Lagerkosten
	{
...
//*** Methode zum Aktualisieren der Solverini ***--------------------------
	public void solveriniAktualisieren()
	{
		...
		try
		{
			BufferedWriter w = new BufferedWriter(new FileWriter("solverini.txt"));	//Öffnen bzw. Erstellen der
