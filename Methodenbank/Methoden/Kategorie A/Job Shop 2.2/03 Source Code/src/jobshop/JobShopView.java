...
public class JobShopView extends FrameView {
    ...
    private final JFileChooser fileChooser2 = new JFileChooser("example");
    ...
    private void initComponents() {
        ...
        Hilfefunktion.setText(resourceMap.getString("Hilfefunktion.text")); 
        Hilfefunktion.setName("Hilfefunktion"); 
        ...
        Hilfefunktion.add(helpMenuItem);
        
        menuBar.add(Hilfefunktion);
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
    	...
    	break;
    		...
    		case 2:
    			JOptionPane.showMessageDialog(null,"Das GLPK Solver ist noch zu implementieren", "Information", JOptionPane.INFORMATION_MESSAGE);
    			solverWahl=0;
    			break;
    			
    		default:
    			JOptionPane.showMessageDialog(null,"Sie haben keinen Solver ausgew‰hlt!", "Solver nicht gew‰hlt", JOptionPane.WARNING_MESSAGE);
	...
	public void hilfeMenue_actionPerformed(ActionEvent e) {
		...
		frame.setTitle("Hilfe zu Job Shop 2.2");
