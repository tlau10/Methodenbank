 ...
 * <p>Description: Die Klasse Empfaenger stellt einen Empfaenger von z.B. G�tern dar. Sie bilden das Gegenst�ck zu Produzenten.</p>
...
public class Empfaenger extends java.awt.geom.Rectangle2D.Double implements Serializable {
  ...
  /**
   * Diese Methode setzt die benoetigte Menge des Objekts.
   *
  ...
  /**
   * Diese Methode liefert den Namen des Objekts zurueck.
   *
  ...
  /**
   * Diese Methode liefert die benoetigte Menge des Objekts zurueck.
   *
  ...
  /**
   * Diese Methode liefert die Id des Objekts zurueck.
   *
  ...
  /**
   * Diese Methode liefert die Hoehe des Objekts zurueck.
   *
  ...
  /**
   * Diese Methode liefert die Y-Koordinate des Objekts zurueck.
   *
