...
public class FrameAlternative extends JFrame {
  ...
  public FrameAlternative(Frame1 frame, Manager manager, Belegung belegung, Date wunschDatum, Date anfang, int buchung, int tagesPreis) {
    try {
      this.frame = frame;
      this.manager = manager;
      this.belegung = belegung;
      jbInit(wunschDatum, anfang, buchung, tagesPreis);
  ...
  private void jbInit(Date wunschDatum, Date anfang, int buchung, int tagesPreis) throws Exception {
    contentPane = (JPanel) this.getContentPane();
    border1 = BorderFactory.createEtchedBorder(Color.white,new Color(148, 145, 140));
    titledBorder1 = new TitledBorder(border1,"Buchungsvorschlag");
    this.setSize(new Dimension(440, 336));
    this.setTitle(" Buchungsvorschlag");
    jPanel1.setLayout(null);
    jPanel2.setBorder(titledBorder1);
    jPanel2.setBounds(new Rectangle(16, 16, 395, 219));
    ...
    jButton1.setBounds(new Rectangle(19, 249, 165, 35));
    ...
    jButton2.setBounds(new Rectangle(234, 249, 174, 36));
