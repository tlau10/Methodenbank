...
class GraphPanel extends Panel implements Runnable {
    ...
    final Color fixedColor = Color.white;       // center-Parameter-Farbe
...
public class Graph extends Applet {
	...
	Panel p = new Panel();
	add("South", p);
	p.add(new Button("Verrühren"));
	p.add(new Button("Schütteln"));
	p.add(new Checkbox("Werte anzeigen"));
	p.add(new Checkbox("Zufall"));
	...
	if (arg instanceof Boolean) {
	    if (((Checkbox)evt.target).getLabel().equals("Werte anzeigen")) {
