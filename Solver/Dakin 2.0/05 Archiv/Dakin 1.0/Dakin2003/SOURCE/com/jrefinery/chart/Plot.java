 ...
 *                   Andreas Schneider;
 *
 * $Id: Plot.java,v 1.8 2002/10/14 16:41:34 mungady Exp $
 *
...
public abstract class Plot implements AxisChangeListener, DatasetChangeListener, AxisConstants {
    ...
    protected static final Paint DEFAULT_OUTLINE_PAINT = Color.darkGray;
    ...
    protected Plot(Dataset data,
        ...
        this.seriesPaint = new Paint[] {Color.blue, Color.green, Color.red,
                                        Color.pink, Color.black, Color.darkGray, Color.magenta,
