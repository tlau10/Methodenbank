...
public class TableauController implements Initializable {
	...
	private static int anzColumns = 2;
	private static int anzRows = 2;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		tabView.setOnMouseClicked(new EventHandler<Event>() {
	...
	public void buildingNewTableau(TableauDTO tableauDTO) {
		...
		anzColumns = tabView.getColumns().size()-2;
		anzRows = tabView.getItems().size()-1;
		System.out.println(tabView.getItems().size());
...
//		tabView.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
	...
	public static int getAnzColumns() {
		return anzColumns;
	}
