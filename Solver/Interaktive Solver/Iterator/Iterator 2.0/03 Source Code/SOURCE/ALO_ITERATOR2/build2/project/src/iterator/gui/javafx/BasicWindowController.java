	...
	public void initialize(URL location, ResourceBundle resources) {
			...
			public void handle(ActionEvent event) {
				try {
					...
					do{
						...
						initFile = new File(currentPath + "\\DATEN");
		...
		itemAbout.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				String title = "I T E R A T O R  2013";
				String message = "\r\n\r\n\r\n"+
				...
				Dialogs.showInformationDialog(primaryStage ,message,title,"About Iterator");
			}
		});
		...
		itemDocumentation.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				try {
					File file = new File("doc_html/iterator2013.html");
