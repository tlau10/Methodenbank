...
Diese FaBePlan-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in FaBePlan.rc, um Schaltflächen für die
