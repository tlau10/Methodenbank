...
/**
 * Ruft den XA Solver auf. Kommunikation erfolgt über Input Files und
 * Output Files.
 *
  ...
  */
  public int solve()
  {
    ...
    { // Kommandodatei erzeugen für Solver Aufruf
      ...
      out.println("            LISTINPUT YES WARNING NO");
    ...
    // Den Solver über sStapeldatei ausführen
