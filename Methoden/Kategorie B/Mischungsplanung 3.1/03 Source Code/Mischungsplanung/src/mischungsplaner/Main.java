...
import mischungsplaner.model.lpBuilder.*;
...
public class Main extends javax.swing.JFrame {
    ...
    private void loadSortenTable(Eingabe eingabe) {
        ...
        while (it.hasNext()) {
            ...
            tm.addColumn("Sorte " + sorteCounter,column);
            sorteCounter++;
        }
    ...
    private void initAnforderungVectors() {
        ...
        initAnforderungColumnNames.add("Eigenschaft");
        initAnforderungColumnNames.add("Wert");
        
        // Beispieldaten für Testzwecke
       
        initAnforderungData = new Vector();
        final Vector row1 = new Vector();
        row1.add("");
   ...
   */
    private void initSortenVectors() {
        ...
        initSortenColumnNames.add("Sorte 1");
    ...
    private void createAnforderungTable() {
        ...
        jTableAnforderung.addFocusListener(new FocusAdapter() {
            public void focusGained(FocusEvent e) {
            	int i = jTableAnforderung.getSelectedRow();
            	int j = jTableAnforderung.getSelectedColumn();
            	
                	Object o = jTableAnforderung.getValueAt(i, j);
                	o = "";
                    jTableAnforderung.setValueAt(o,i, j);
            }
        });
    ...
    private void createSortenTable() {
        ...
        jTableSorten.addFocusListener(new FocusAdapter() {
            public void focusGained(FocusEvent e) {
            	
            	int i = jTableSorten.getSelectedRow();
            	int j = jTableSorten.getSelectedColumn();
            	
            		if (j != 0) {
                	Object o = jTableSorten.getValueAt(i, j);
                	o = "";
                    jTableSorten.setValueAt(o,i, j);
            		}
            }
        });
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabelAnforderung.setText("Anforderung");
        ...
        jMenuItem_Beenden.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_BeendenActionPerformed(evt);
            }
        });
       ...
       // jMenuSolver.add(jRadioButtonXA);							XA als Solver deaktivieren
    ...
    private void jMenuItem_HilfeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_HilfeActionPerformed
        jPanel_Answer.setVisible(false);
        try {
            Runtime.getRuntime().exec("rundll32 url.dll, FileProtocolHandler "+ new java.io.File("hilfe.html").getAbsolutePath());
        } catch (Exception e)
        {}
    }//GEN-LAST:event_jMenuItem_HilfeActionPerformed
    
    private void jMenuItem_BeendenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_HilfeActionPerformed
        jPanel_Answer.setVisible(false);
        try {
            System.exit(0);
        } catch (Exception e)
    ...
    private void jMenuItem_OeffnenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_OeffnenActionPerformed
        jPanel_Answer.setVisible(false);
        JFileChooser chooser = new JFileChooser("C:\\Methodenbank\\Methoden\\Kategorie B\\Mischungsplanung 3.1\\01 Programm\\Beispieldaten");
        chooser.setFileFilter(new XMLFileFilter());
    ...
    private void jMenuItem_NeuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_NeuActionPerformed
        ...
        int eingabe = JOptionPane.showConfirmDialog(null, "Wollen Sie ein neues Projekt anlegen? Dabei geht das alte Projekt verloren.");
        if(eingabe==0){
        initAnforderungVectors();
    ...
    private void addAnforderungButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addAnforderungButtonActionPerformed
        ...
        DefaultTableModel tm = (DefaultTableModel) jTableAnforderung.getModel();
        Vector sorteData2 = new Vector();
        sorteData2.add(new String(""));
        for (int i=1;i<tm.getColumnCount();i++) {
            sorteData2.add(new String("0.0"));
        }
        tm.insertRow(tm.getRowCount()-1,sorteData2);
    ...
    private void addSorteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSorteButtonActionPerformed
        ...
        tm.addColumn("Sorte " + (colcount),data);
