...
public class Grunddaten implements ActionListener {
	...
	public Grunddaten(WerbeBudgetApplication w) {
		...
		budgetLabel = new JLabel("Maximal zur Verfgung stehendes Budget: ");
		...
		maennlichRadioButton = new JRadioButton("maennlich");
		...
		maximalKunden = new JRadioButton("Maximierung der potentiellen Kufer");
	...
	public boolean saveOptions() {
		if (wb.getSolverDaten().setBudget(budgetField.getText()) == false) {
			JOptionPane.showMessageDialog(null,
					"Kein bzw. fehlerhafter Wert fr Budget eingegeben",
					"Fehler", JOptionPane.ERROR_MESSAGE);
			return false;
		}
