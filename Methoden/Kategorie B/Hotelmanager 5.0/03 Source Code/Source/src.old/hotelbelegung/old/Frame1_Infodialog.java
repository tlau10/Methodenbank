...
public class Frame1_Infodialog extends JDialog implements ActionListener {
	...
	private static final long serialVersionUID = -2417657479888402814L;
	...
	String product = "Hotel-Manager V 2.0.1";
	...
	String Reperatur = "Version 2.0.1: SS2008 Christian Gruhler";
	...
	private void jbInit() throws Exception {
		...
		// ImageIcon(Frame1_Infodialog.class.getResource("[Ihre Grafik]")));
		this.setTitle("Info");
		setResizable(false);
