...
public class Frame1 extends JFrame {
	...
	private String solverPfad = new String("L:\\Besf\\Solver\\");
  ...
  private void init() throws Exception  {
	...
	JahrJComboBox.addItem("2003");
	JahrJComboBox.addItem("2004");
	JahrJComboBox.addItem("2005");
	JahrJComboBox.addItem("2006");
	JahrJComboBox.addItem("2007");
	JahrJComboBox.addItem("2008");
	...
	SolverpfadJLabel.setText("Solverpfad:");
	SolverpfadJLabel.setBounds(new Rectangle(35, 38, 81, 17));
  ...
  if ((JahrJComboBox.getSelectedIndex() == 3 || JahrJComboBox.getSelectedIndex() == 7) &&
       MonatJComboBox.getSelectedIndex() == 3 && TagJComboBox.getSelectedIndex() > 30)
        {
          JOptionPane.showMessageDialog(null, "Achtung: Ungültiges Datum eingegeben. Das ist ein Schaltjahr.");
          return;
        }
  if (TagJComboBox.getSelectedIndex() > 27 && MonatJComboBox.getSelectedIndex() == 3 &&
      JahrJComboBox.getSelectedIndex() != 3 && JahrJComboBox.getSelectedIndex() != 7)
        {
  ...
  if (DauerJComboBox.getSelectedIndex() == 0 || DauerJComboBox.getSelectedIndex() == 1)
    ...
    try {
    	int parseDatum = ((JahrJComboBox.getSelectedIndex()+2001)*10000)+((MonatJComboBox.getSelectedIndex()-1)*100)+(TagJComboBox.getSelectedIndex()-1);
