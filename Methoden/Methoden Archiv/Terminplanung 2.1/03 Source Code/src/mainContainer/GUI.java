...
public class GUI {
	...
	private void initialize() {
		frame = new JFrame("Terminplanung");
		...
		JButton btnNewButton = new JButton("Terminserien-Übersicht");
...
//				}
				...
				String[][] array_str = new String[evolution.getMaxgen()+10][12];	
				...
				JTableUI table = new JTableUI( "Terminserien-Übersicht", fields, pivot, evolution.getBestleb());
		...
		springLayout.putConstraint(SpringLayout.NORTH, btnNewButton, 6, SpringLayout.SOUTH, lblTermine);
