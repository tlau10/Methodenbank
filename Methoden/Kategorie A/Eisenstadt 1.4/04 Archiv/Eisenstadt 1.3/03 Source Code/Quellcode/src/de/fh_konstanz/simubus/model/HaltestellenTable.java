...
/**
 * Die Klasse <code>HaltestellenTable</code> ist eine Tabelle, welche die
 * Daten aller Haltestellen hält.
 * 
...
public class HaltestellenTable extends AbstractTableModel
{
    ...
    * 
    * @param haltestellen Haltestellen fuer Liste
    */
   ...
   public void setValueAt( Object aValue, int row, int col )
   {
      ...
      else if ( col == 1 )
      {
         ...
         Object o[] = SimuPanel.getInstance().getGraph().getGraphLayoutCache().getCells( false, true, false,
               false );
