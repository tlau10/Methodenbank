...
public class matrixPlanQuadratController
{
        ...
        public void setztPlanQuadrate(ArrayList arrayList)
        {
        	...
        	if (Boolean.parseBoolean(arrayList.get(9).toString()))
        	{
        		mPQ.setzePassierbar(Boolean.parseBoolean(arrayList.get(9).toString()));
        	}
        	
        	if (Boolean.parseBoolean(arrayList.get(10).toString()))
        	{
        		mPQ.setzePotentHalteStelle(Boolean.parseBoolean(arrayList.get(10).toString()));
        	}
