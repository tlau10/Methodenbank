...
public class Haltestelle implements Serializable {
	...
	/**
	 * Konstruktor, hier wird ein <code>Point</code>,ein <code>String</code> und
	 * ein Integer-Wert übergeben, mit der die Haltestelle angelegt wird,der
	...
	/**
	 * 
	 * @return liefert die <code>Point</code>-Koordinaten der Haltestelle zurück
	 */
