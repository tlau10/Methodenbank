...
/**
 * Die Klasse <code>SimuEinstellungen</code> ist ein Fenster mit allgemeinen
 * Einstellungen.
 * 
 * @author ???
...
public class SimuEinstellungen extends JFrame {
	...
	public SimuEinstellungen() {
		super("Einstellungen");
		this.setIconImage(new ToolkitImage(new URLImageSource(ImageUtil.getImageUrl("haltestelle.png"))));
