...
/**
 * Die Klasse <code>IntegerEditor</code> implementiert einen Editor, der ein
 * Textfield verwendet um Integer Werte zu ändern
 * 
...
public class IntegerEditor extends DefaultCellEditor {
	...
	protected boolean userSaysRevert() {
		...
		ftf.selectAll();
		Object[] options = { "Bearbeiten", "Zurücksetzen" };
		int answer = JOptionPane.showOptionDialog(SwingUtilities.getWindowAncestor(ftf),
				"Es können nur ganzzahlige Werte zwischen " + minimum + " und " + maximum + " eingegeben werden.",
				"Eingabe nicht zulässig", JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE, null, options,
				options[1]);
