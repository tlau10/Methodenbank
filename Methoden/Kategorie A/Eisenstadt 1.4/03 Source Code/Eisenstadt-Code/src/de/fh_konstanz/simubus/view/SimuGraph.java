...
public class SimuGraph extends JGraph {
	...
	public String getToolTipText(MouseEvent e) {
		if (e != null) {
			...
			} else if (cell instanceof GesperrteHaltestelleCell) {
				return ((GesperrteHaltestelleCell) cell).getToolTipString();
			} else if (cell instanceof GesperrteFelderEdge) {
				return ((GesperrteFelderEdge) cell).getToolTipString();
			} else if (cell instanceof LinienEdge) {
				return ((LinienEdge) cell).getToolTipString();
			} else if (cell instanceof StrassenEdge) {
				return ((StrassenEdge) cell).getToolTipString();
			} else if (cell instanceof ZieleCell) {
				return ((ZieleCell) cell).getToolTipString();
			}
		}
		return null;
	}
