...
public class Planquadrat implements Serializable {
	...
	/**
	 * Die Werte f,g,h und father dienen zur Berechnung des kürzesten Weges
	 * durch den PathfinderOR
	 */
	 ...
	 */
	private int sizeOfField = SimuKonfiguration.getInstance().getFeldElementGroesse();
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Planquadrat) {
			if (((Planquadrat) obj).getPlanquadratCoordinates().equals(getPlanquadratCoordinates()) == true) {
				result = true;
			}
		}
		return result;
