...
/*      // Eintrag der Schaltervariablen in separates Array (zur Überprüfung der max. Belegung)
  ...
  public void setAlternative(Date optDatum, int tage, int preis, int kategorie) {
    ...
    if((vglWunschDatum == vglAltDatum) && (kategorie == mainFrame.getZimmerKategorie())) {
      JOptionPane.showMessageDialog(null, "Check-in am " + outFormat.format(optDatum) + "  -  Aufenthaltsdauer " + tage + " Tag(e)  -  Gesamtpreis € " + gesPreis, "Gewünschte Reservierung vorgenommen", 1);
