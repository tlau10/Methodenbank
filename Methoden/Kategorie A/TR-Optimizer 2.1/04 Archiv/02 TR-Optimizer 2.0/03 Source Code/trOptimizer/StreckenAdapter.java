...
public class StreckenAdapter extends MouseAdapter implements MouseMotionListener {
  ...
  /**
   * Diese Methode wird überschrieben und aufgerufen, wenn die Maus bewegt wird.
   *
   * @param e
   */
  ...
  /**
   * Diese Methode wird überschrieben und aufgerufen, wenn die Maus gedraggt also gezogen wird.
   * @param e
   */
