...
/**
 * <p>Title: Strecke</p>
 * <p>Description: Diese Klasse stellt eine Strecke dar. Also die Verbindung zwischen Produzenten und Empfängern.</p>
...
public class Strecke implements Serializable {
  ...
  private int ziel; // id vom empfänger
  private int entfernung;
  private int x1Koordinate, y1Koordinate, x2Koordinate, y2Koordinate;

  /**
   * Diese Konstruktor erwartet die Id des Objekts, die vom Controller übergeben wird.
  ...
  /**
   * Diese Konstruktor erwartet sowohl die Id als auch die Koordinate des Objekts, die vom Controller übergeben werden.
   *
   * @param x1 - Koordinate
   * @param y1 - Koordinate
   * @param x2 - Koordinate
   ...
   *
   * @param idProduzent id des zugehörigen produzenten
   */
   ...
   *
   * @param idEmpfaenger id des zugehörigen empfaengers
   */
  ...
  /**
   * Diese Methode liefert die Quelle des Objekts zurück.
   *
  ...
  /**
   * Diese Methode liefert das Ziel des Objekts zurück.
   *
  ...
  /**
   * Diese Methode liefert die Entfernung zweier verbundener Objekte zurück.
   *
  ...
  /**
   * Diese Methode liefert die Id des Objekt zurück.
   *
  ...
  /**
   * Diese Methode liefert die erste X-Koordinate des Objekts zurück.
   *
  ...
  /**
   * Diese Methode liefert die zweite X-Koordinate des Objekts zurück.
   *
  ...
  /**
   * Diese Methode liefert die erste Y-Koordinate des Objekts zurück.
   *
  ...
  /**
   * Diese Methode liefert die zweite Y-Koordinate des Objekts zurück.
   *
