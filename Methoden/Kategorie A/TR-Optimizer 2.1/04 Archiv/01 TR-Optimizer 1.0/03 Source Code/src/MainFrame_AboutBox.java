 ...
 * <p>Description: Die Klasse dient als About-Box. Sie enthält lediglich Informationen über die Anwendung (Die Verantwortlichen bzw. Betreuer).</p>
...
public class MainFrame_AboutBox extends JDialog implements ActionListener {
  ...
  private void jbInit() throws Exception {
    ...
    panel1.add( button1, new XYConstraints( 104, 202, -1, -1 ) );
    panel1.add( imageLabel, new XYConstraints( 15, 11, -1, -1 ) );
    this.getContentPane().add( panel1, new XYConstraints( 0, 0, 263, 242 ) );
    setResizable( true );
  }

  /**
   * Überschriebene Methode um die Informations- bzw. Dialog-Box zu schliessen.
   *
  ...
  /**
   * Diese Methode ist für das Schliessen der Dialog-Box zuständig.
   *
   */
  void cancel() {
    dispose();
  ...
  /**
   * Überschriebene Methode um auf Ereignisse zu reagieren. Z.B. um Fenster zu schliessen bei OK-Buttonklick.
   *
