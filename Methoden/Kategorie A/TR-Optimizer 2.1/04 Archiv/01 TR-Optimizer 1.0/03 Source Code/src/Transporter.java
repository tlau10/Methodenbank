 ...
 * <p>Description: Die Klasse Transporter stellt einen Transporter der zwischen Produzenten und Empfänger liefert dar.</p>
...
public class Transporter extends java.awt.geom.Rectangle2D.Double implements Serializable {
  ...
  /**
   *
   * Diese Methode zeichnet den Transporter als Rechteck mit den übergebenen Koordinaten bzw. setzt die Koordinaten
   *
   * @param xKoordinate
   * @param yKoordinate
   */
  ...
  /**
   * Diese Methode setzt die Kapazität des Transporters
   *
  ...
  /**
   * Diese Methode liefert die Kapazität des Transporters zurück.
   *
  ...
  /**
   *  Diese Methode liefert den Namen des Transporters zurück.
   *
  ...
  /**
   * Diese Methode liefert die Kosten pro km zurück.
  ...
  /**
   * Diese Methode liefert die Id des Transporters zurück.
  ...
  /**
   * Diese Methode liefert die Höhe des Objekt zurück.
  ...
  /**
   * Diese Methode liefert die Y-Koordinate des Ojekts zurück.
