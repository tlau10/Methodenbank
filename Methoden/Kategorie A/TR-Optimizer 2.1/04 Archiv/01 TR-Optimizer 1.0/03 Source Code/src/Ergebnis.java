...
public class Ergebnis {
  ...
  /**
   * Diese Methode liefert den Ladung zurück.
   *
  ...
  /**
   * Diese Methode liefert die Id der Quelle zurück.
  ...
  /**
   * Diese Methode liefert die Id des Ziels zurück.
   *
   * @return Id des Ziels
   */
  public int getZiel() {
  ...
  /**
   * Diese Methode liefert die Kosten zurück.
   *
