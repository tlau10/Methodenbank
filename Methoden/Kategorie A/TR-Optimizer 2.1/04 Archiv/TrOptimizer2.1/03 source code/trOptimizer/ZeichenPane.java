 ...
 * <p>Description: Die Klasse ZeichePane stellt das eigentliche Zeichenfeld dar. In ihr werden die Produzente, Empf�nger und Strecken gezeichnet.</p>
...
public class ZeichenPane extends JPanel {
  ...
  /**
   * Die Methode paint ist eine Java-Standard-Methode und wird hier mit den gewuenschten Eigenschaften ueberschrieben.
...
*/
  ...
  /**
   * Diese Methode setzt die aktuellen Empfaenger.
   * @param _empfaenger Vector mit den aktuellen Empfaengern
   */
  ...
  /**
   * Diese Methode wird im TransportController für die printTempLine benoetigt, damit die Anwendung weiss, ob
