...
public class ZeichenAdapter extends MouseAdapter {
  ...
  /**
   * Diese Methode wird ueberschrieben und aufgerufen, wenn die Maus gedrueckt gehalten wird.
   * @param e
   */
  ...
  /**
   * Diese Methode wird ueberschrieben und aufgerufen, wenn die Maus losgelassen wird.
   * @param e
   */
  ...
  /**
   * Diese Methode ueberprueft, ob es sich um ein doppelklick gehandlet hat.
   * Falls ja, wird das PopUp-Menue aufgerufen.
   *
   * @param e
   */
  ...
  /**
   * Diese Methode überprueft, ob innerhalb der Zeichenflaeche die Maus gedrueckt gehalten wird.
   *
   * @param e
   */
  ...
  /**
   * Diese Methode ueberprueft, ob innerhalb der Zeichenflaeche die Maus losgelassen wurde.
   *
   * @param e
   */
