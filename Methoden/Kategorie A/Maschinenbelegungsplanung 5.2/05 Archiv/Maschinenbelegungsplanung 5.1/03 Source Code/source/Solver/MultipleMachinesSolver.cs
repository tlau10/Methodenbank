...
namespace Maschinenbelegungsplanung
{
	public class MultipleMachinesSolver : ISolver
	{
		...
		public MultipleMachinesSolver(eingabeDaten inEingabeDatenParam, String inChosenSolver, String inSolverPathParam, String inWorkDirParam, int inAnzahlMaschinen )
		{
		...
		private void createBatchFile()
		{
			...
			{
				case "LP-Solve":
					m_SrwInputFile.WriteLine(solverPath + "\\lp_solve.exe -mps <" + workDir + "\\mbp2003.mps" + "> " + workDir + "\\mbp2003_multiple.out" );
					break;
