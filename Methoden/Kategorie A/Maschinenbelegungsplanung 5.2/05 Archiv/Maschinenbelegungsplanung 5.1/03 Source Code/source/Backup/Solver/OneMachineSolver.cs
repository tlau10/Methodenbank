...
namespace Maschinenbelegungsplanung
{
	...
	public class OneMachineSolver : ISolver
	{
		...
		/// Bsplw. C:\Temp 
		///</param>
		public OneMachineSolver( eingabeDaten eingabeDatenParam, String chosenSolver, String solverPathParam, String workDirParam )
		{
		...
		private bool createBatchFile()
		{
			...
			{
				case "LP-Solve":
					m_SrwInputFile.WriteLine(solverPath + "\\lp_solve.exe -mps <" + workDir + "\\mbp2003.mps" + "> " + workDir + "\\mbp2003_single.out" );
					break;
