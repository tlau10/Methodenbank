...
namespace Maschinenbelegungsplanung
{
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        //Solverpfad wird nun über Einstellungen.xml Datei eingelesen
        public static string solverPath = Einstellungen.Default.SolverPfad;
        //----------------------------------------------------------------------------------
        //Arbeitsverzeichnis wird nun über Einstellungen.xml Datei eingelesen
		public static string workingDir = Einstellungen.Default.Arbeitsverzeichnis;
        //----------------------------------------------------------------------------------
