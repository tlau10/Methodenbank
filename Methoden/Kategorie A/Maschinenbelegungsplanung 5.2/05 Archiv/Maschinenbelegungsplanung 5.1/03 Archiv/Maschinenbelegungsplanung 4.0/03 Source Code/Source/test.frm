...
Begin VB.Form Form1 
   ...
   Begin ComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {0713E452-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty Button1 {0713F354-850A-101B-AFC0-4210102A8DA7} 
            Caption         =   "Neu"
            Key             =   "neu"
            Description     =   "Neue Datei anlegen"
         ...
         BeginProperty Button2 {0713F354-850A-101B-AFC0-4210102A8DA7} 
            Caption         =   "Öffnen"
            Key             =   "oeffnen"
            Object.ToolTipText     =   "Öffnen einer vorhandenen Datei"
            Object.Tag             =   ""
            ImageIndex      =   2
         EndProperty
         BeginProperty Button3 {0713F354-850A-101B-AFC0-4210102A8DA7} 
            Caption         =   "Speichern"
            Key             =   "speichern"
            Description     =   "Speichern der aktuellen Tabellenwerten"
            Object.ToolTipText     =   "Speichern Sie Ihre Eingaben"
            Object.Tag             =   ""
            ImageIndex      =   3
         EndProperty
         ...
         BeginProperty Button7 {0713F354-850A-101B-AFC0-4210102A8DA7} 
            Caption         =   "Verzeichnis"
            Key             =   "Verzeichnis"
            Object.ToolTipText     =   "Verzeichnis für temporäre Dateien"
            Object.Tag             =   ""
            ImageIndex      =   8
         EndProperty
         ...
         BeginProperty Button9 {0713F354-850A-101B-AFC0-4210102A8DA7} 
            Caption         =   "Numerisch"
            Key             =   "Numerisch"
            Object.ToolTipText     =   "Ergebnis numerisch anzeigen"
            Object.Tag             =   ""
            ImageIndex      =   11
            Style           =   1
            Value           =   1
         ...
         BeginProperty Button10 {0713F354-850A-101B-AFC0-4210102A8DA7} 
            Caption         =   "Grafik"
            Key             =   "Grafik"
            Object.ToolTipText     =   "Art der Grafik"
            Object.Tag             =   ""
            ImageIndex      =   4
            Style           =   1
            Value           =   1
         ...
         BeginProperty Button12 {0713F354-850A-101B-AFC0-4210102A8DA7} 
            Caption         =   "?"
            Key             =   "?"
            Object.ToolTipText     =   "Über Maschinenbelegeungsplanung"
            Object.Tag             =   ""
            ImageIndex      =   10
            Object.Width           =   1e-4
         EndProperty
   ...
   Begin MSFlexGridLib.MSFlexGrid tabelle_auftragsdaten 
      ...
      ScrollBars      =   2
   End
   Begin VB.CommandButton Chart_zeichnen 
      Caption         =   "Command1"
      Height          =   375
      Left            =   1800
      TabIndex        =   0
   ...
   Begin MSFlexGridLib.MSFlexGrid tabelle_maschinendaten 
      ...
      Appearance      =   0
   End
   Begin MSFlexGridLib.MSFlexGrid Robert2 
      Height          =   645
      Left            =   480
      TabIndex        =   10
      Top             =   5880
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":031A
            Key             =   "oeffnen"
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":0634
            Key             =   "speichern"
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":094E
            Key             =   "grafsich"
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":0C68
            Key             =   "Zielfunktion"
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":0F82
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":129C
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":15B6
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":18D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":1BEA
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "test.frx":1F04
            Key             =   ""
         EndProperty
      EndProperty
   End
       ...
       For s = 1 To max_auftragsnr
           ...
           If beginn <= z And Ende >= z Then
              If i > 0 Then
                 RestStr = RestStr & "+"
              End If
              RestStr = RestStr + "1x" & zaehler_zeile & s_var & zaehler_zeile & z_var
              i = 1
           End If
           If s_var = 9 Then
              zaehler_spalte = zaehler_spalte + 1
...
Private Sub Chart_zeichnen_Click()
...
tabelle_auftragsdaten.ColWidth(1) = 1300
...
tabelle_auftragsdaten.Width = 6600
...
If Err = 62 Or zeile = "This problem is infeasible" Then
    MsgBox "Das Problem ist nicht lösbar! Bitte überprüfen Sie die Eingabewerte."
    Close #1
    Exit Sub
End If
...
Do Until EOF(1)
  ...
  If (Mid(x_var, 1, 1)) <> "Y" Then
    ...
    If auftragsnr > row_aktuell Then
        Tabelle.robert1.Rows = Tabelle.robert1.Rows + 1
    End If
...
If grafik_anz = 1 Then
    grafik_click
End If
If tabelle_anz = 1 Then
    Tabelle.Show
End If
