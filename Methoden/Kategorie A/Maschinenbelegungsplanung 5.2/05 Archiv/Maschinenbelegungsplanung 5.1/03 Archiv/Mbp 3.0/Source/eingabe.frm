   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":0442
            Key             =   "graphik"
            Object.Tag             =   "/icons/Graph07.ico"
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":075C
            Key             =   "hilfe"
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":086E
            Key             =   "numerisch"
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":0B88
            Key             =   "neu"
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":0C9A
            Key             =   "oeffnen"
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":0DAC
            Key             =   "drucken"
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":0EBE
            Key             =   "speichern"
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":0FD0
            Key             =   "zielfunktion"
         EndProperty
         BeginProperty ListImage9 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":12EA
            Key             =   "berechnung"
         EndProperty
         BeginProperty ListImage10 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "eingabe.frx":1604
            Key             =   "zielverzeichnis"
         EndProperty
      EndProperty
   End
...
'>>>>>>>>>>>>>>>>>> ersetzen durch arbeitsverz.
'Open pfad.Text + "\lpsolve.lp" For Output As #1
Open "c:\temp\mbp.lp" For Output As #1
...
Sub solver_laden()
   ...
   Print #1, LpsolvePfad + "\lp_solve.exe <" + ArbeitsVerz + "\mbp.lp >" + ArbeitsVerz + "\lp_solve.out"
...
' Datei öffnen
Open ArbeitsVerz + "\lp_solve.out" For Input As #1
