...
namespace Maschinenbelegungsplanung
{
	...
	public class InputForm : System.Windows.Forms.Form
	{
        ...
        public static string solver = "GLPK";
		...
		public InputForm()
		{
			...
			InitializeComponent();
			Form1.printableAuftraegeDataGridOM += new PrintableAuftraegeDataGrid( returnDataGridAuftraege );
			Form1.printablePeriodenDataGridOM += new PrintablePeriodenDataGrid( returnDataGridPerioden );			
		}
		#endregion
		...
		private void InitializeComponent()
		{
			...
			// Dropdown zur Auswahl des Solvers aktualisiert und aktiviert
            ...
            this.comboBox1.SelectedIndexChanged += new System.EventHandler(this.solverSelected);
			// 
			// label1
			// 
        ...
        /*
         *Merkt sich den ausgewählten Solver 
         */
        private void solverSelected(object sender, System.EventArgs e)
        {
            InputForm.solver = this.comboBox1.SelectedItem.ToString();
        }
