...
type
  ...
  public
    ...
    procedure SetStatusInfo(Text: String);
  end;
...
uses Status, Einstellungen, InfoForm;
...
var AnzahlOrte: Word;
    ...
    Wert: Cardinal;
begin
     OeffnenDialog.InitialDir := Datenpfad ;    // Voreinstell. Datenpfad
...
procedure TFormular.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     if DateiOn then
     begin
...
procedure TFormular.SetStatusInfo(Text: String);
begin
