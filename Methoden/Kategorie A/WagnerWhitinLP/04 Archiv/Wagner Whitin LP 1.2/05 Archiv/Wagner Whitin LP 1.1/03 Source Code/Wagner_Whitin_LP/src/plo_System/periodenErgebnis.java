...
//*		die Berechnungsergebnisse fuer eine bestimmte Periode		*
//*		verwaltet													*
//*																	*
//*		Version: 1.0												*
//*																	*
...
//*** GET-Methoden  ***-----------------------------------------------
	public String getTf_NummerText()									//Methode zur Rueckgabe des Textes im Textfeld Periodennummer
	{
		return this.tf_Nummer.getText();
	}

	public String getTf_BestellmengeText()								//Methode zur Rueckgabe des Textes im Textfeld Periodenbestellmenge
	{
		return this.tf_Bestellmenge.getText();
	}

	public String getTf_LagermengeText()								//Methode zur Rueckgabe des Textes im Textfeld Periodenlagermenge
	{
		return this.tf_Lagermenge.getText();
	}

	public String getTf_FehlmengeText()									//Methode zur Rueckgabe des Textes im Textfeld Periodenfehlmenge
	{
		return this.tf_Fehlmenge.getText();
	}

	public String getTf_LagerhaltungskostenText()						//Methode zur Rueckgabe des Textes im Textfeld Periodenlagerhaltungskosten
	{
		return this.tf_Lagerhaltungskosten.getText();
	}

	public JTextField getTf_Nummer()									//Methode zur Rueckgabe des Textfeldes Periodennummer
	{
		return this.tf_Nummer;
	}

	public JTextField getTf_Bestellmenge()								//Methode zur Rueckgabe des Textfeldes Periodenbestellmenge
	{
		return this.tf_Bestellmenge;
	}

	public JTextField getTf_Lagermenge()								//Methode zur Rueckgabe des Textfeldes Periodenlagermenge
	{
		return this.tf_Lagermenge;
	}

	public JTextField getTf_Fehlmenge()									//Methode zur Rueckgabe des Textfeldes Periodenfehlmenge
	{
		return this.tf_Fehlmenge;
	}

	public JTextField getTf_Lagerhaltungskosten()						//Methode zur Rueckgabe des Textfeldes Periodenlagerhaltungskosten
	{
