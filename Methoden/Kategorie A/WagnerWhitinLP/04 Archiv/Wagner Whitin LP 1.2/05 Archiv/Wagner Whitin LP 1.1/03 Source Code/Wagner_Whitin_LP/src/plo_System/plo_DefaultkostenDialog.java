...
//*																	*
//*		Synopsis: Enthuelt die Klasse fuer den User-Dialog, 		*
//*		in welchem die Standartwerte fuer Bestell- und Lager-		*
//*		kosten zur Laufzeit veraendert werden koennen				*
//*																	*
//*		Version: 1.0												*
//*																	*
//*******************************************************************
...
//*** Konstruktor ***------------------------------------------------------
	public plo_DefaultkostenDialog(plo_Hauptfenster base)
	{
		...
		defaultkostenPanel.setLayout(d_DefaultkostenGridBagLayout);		//Hinzufuegen der Komponente
		...
		ActionListener plo_DefkostDiaListener = new ActionListener()	//Definition des Listeners fuer
		{																//Knopfdruecke
			public void actionPerformed(ActionEvent aevt)				//
			{															//
				JButton compare = new JButton();						//Feststellen, welcher Button degrueckt
		...
		jb_Ok.addActionListener(plo_DefkostDiaListener);				//Verbinden von Schaltflaechen und
...
//*** GET-Methoden ***-----------------------------------------------------
	public String getTf_BestellkostenText()								//Methode zur Rueckgabe des Inhalts des Textfelds Bestellkosten
	{
		return tf_Bestellkosten.getText();
	}

	public String getTf_LagerkostenText()								//Methode zur Rueckgabe des Inhalts des Textfelds Lagerkosten
	{
