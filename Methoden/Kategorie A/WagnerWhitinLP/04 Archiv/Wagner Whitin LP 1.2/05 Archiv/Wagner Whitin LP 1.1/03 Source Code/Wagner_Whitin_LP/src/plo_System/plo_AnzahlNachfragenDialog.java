...
//*																	*
//*		Synopsis: Enthaelt die Klasse fuer den User-Dialog, 		*
...
//*** GET-Methoden ***-----------------------------------------------------
	public String getTf_AnzahlNachfragenText()							//Methode zur Rueckgabe des Eingabefeldinhaltes
	{
		return tf_AnzahlNachfragen.getText();
	}

	public int getInt_AnzahlNachfragen()								//Methode zur Rueckgabe der Nachfragenanzahl
	{
