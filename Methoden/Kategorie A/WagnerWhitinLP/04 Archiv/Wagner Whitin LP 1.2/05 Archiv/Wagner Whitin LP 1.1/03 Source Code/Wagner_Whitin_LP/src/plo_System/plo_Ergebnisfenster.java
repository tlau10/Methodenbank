...
//*																	*
//*		Synopsis: Enthuelt die Klasse fuer die Fenster der Loesungs-	*
//*		darstellung									 				*
//*																	*
//*		Version: 1.0												*
//*																	*
...
public class plo_Ergebnisfenster extends JInternalFrame{
	...
	private plo_Eingabemaske ef_ZugehoerigeEingabemaske;				//Referenzobjekt auf das Fenster des zugehoerigen Modells
...
//*** Konstruktor  ***------------------------------------------------
	public plo_Ergebnisfenster(/*int anzahlPeriodenErgebnisse */plo_Hauptfenster base, String title, boolean resizable, boolean maximizable, boolean closable, boolean iconifiable, plo_Eingabemaske parent)
	{
		...
		this.buildConstraints(ef_GridBagConstraints, ef_Periode1, 0, 0, 2, 1, GridBagConstraints.NONE, GridBagConstraints.WEST, 5, 0, new Insets(0,5,0,5));			//Erstellend der Constraints fuer
		...
		plo_ErgebnisPanel.add(ef_Periode1);							//Hinzufuegen der Beschriftungskomponenten
		...
		for(i = 2; i < anzahlPeriodenErgebnisse; i++)			//Initialisieren des Arrays mit
		{
			...
			this.buildConstraints(ef_GridBagConstraints, getEf_PeriodenErgebnisListe(i-2).getTf_Nummer(), 0, i, 2, 1, GridBagConstraints.NONE, GridBagConstraints.NORTHWEST, 5, 5, standard);			//Erstellen der Constraints fuer die Textfelder
			...
			plo_ErgebnisPanel.add(getEf_PeriodenErgebnisListe(i-2).getTf_Nummer());					//Hinzufuegen der Textfelder
...
//*** SET-Methoden  ***-----------------------------------------------
	...
	public void setEf_ZugehoerigeEingabemaske(plo_Eingabemaske elem)	//Methode zum Setzen des Referenzobjekts auf das Modell
	{
...
//*** GET-Methoden  ***-----------------------------------------------
	public String getTf_GesamtkostenText()							//Methode zur Rueckgabe des Gesamtkostentextes
	{
		return tf_Gesamtkosten.getText();
	}

	public boolean getEf_IsSaved()									//Methode zur Rueckgabe isSaved-Variablen
	{
		return ef_IsSaved;
	}

	public plo_Eingabemaske getEf_ZugehoerigeEingabemaske()			//Methode zur Rueckgabe Referenzobjekts auf das Modell
	{
	...
	public int getAnzahlPeriodenErgebnisse()						//Methode zur Rueckgabe der Ergebnisanzahl
	{
		return anzahlPeriodenErgebnisse;
	}

	public periodenErgebnis getEf_PeriodenErgebnisListe(int index)	//Methode zur Rueckgabe eines Elements an eine per Index spezifizierten Stelle des Ergebnis-Arrays
	{
...
//*** Speichermethode  ***--------------------------------------------
	public void loesungSpeichern(String full, String file)					//Methode zum Abspeichern einer errechneten Loesung in einer txt-Datei,
