...
//*																	*
//*		Synopsis: Enthält die Klasse für die Ausgabe verschiedner	*
//*		Fehlermeldungen								 				*
//*																	*
//*		Version: 1.0												*
//*																	*
...
//*** Konstruktor ***-------------------------------------------------
	...
	{
		final plo_FehlerMeldung ref = this;							//Erstellen eines Referenzobjekts für dispose()-Aufrufe
		...
		switch(value)
		{
		case 1:														//Keine gültige Nachfrage ausgewählt
			...
			break;
		case 2:														//Zu großes System
			FehlerLabel1 = new JLabel("Eingabefehler:");
			FehlerLabel2 = new JLabel("-----------------------------------------------");
			FehlerLabel3 = new JLabel("Das eingegebene Modell ist zu groß!");
			break;
