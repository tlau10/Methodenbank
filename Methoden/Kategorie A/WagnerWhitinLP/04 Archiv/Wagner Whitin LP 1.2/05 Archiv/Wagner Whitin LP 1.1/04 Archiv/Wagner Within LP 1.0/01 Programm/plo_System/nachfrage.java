...
//*** GET-Methoden  ***-----------------------------------------------
	public String getTf_NummerText()								//Methode zum Rückgabe des Textes im Textfeld der Nachfragennummer
	{
		return tf_Nummer.getText();
	}

	public String getTf_MengeText()									//Methode zum Rückgabe des Textes im Textfeld der Nachfragemenge
	{
		return tf_Menge.getText();
	}

	public String getTf_PeriodeText()								//Methode zum Rückgabe des Textes im Textfeld der Nachfrageperiode
	{
		return tf_Periode.getText();
	}

	public String getTf_BestellkostenText()							//Methode zum Rückgabe des Textes im Textfeld der Nachfragen-Bestellkosten
	{
		return tf_Bestellkosten.getText();
	}

	public String getTf_LagerkostenText()							//Methode zum Rückgabe des Textes im Textfeld der Nachfragen-Lagerkosten
	{
		return tf_Lagerkosten.getText();
	}

	public JTextField getTf_Nummer()								//Methode zum Rückgabe des TexteFeldes Nachfragennummer
	{
		return tf_Nummer;
	}

	public JTextField getTf_Menge()									//Methode zum Rückgabe des TexteFeldes Nachfragemenge
	{
		return tf_Menge;
	}

	public JTextField getTf_Periode()								//Methode zum Rückgabe des TexteFeldes Nachfragenperiode
	{
		return tf_Periode;
	}

	public JTextField getTf_Bestellkosten()							//Methode zum Rückgabe des TexteFeldes Nachfragen-Bestellkosten
	{
		return tf_Bestellkosten;
	}

	public JTextField getTf_Lagerkosten()							//Methode zum Rückgabe des TexteFeldes Nachfragen-Lagerkosten
	{
