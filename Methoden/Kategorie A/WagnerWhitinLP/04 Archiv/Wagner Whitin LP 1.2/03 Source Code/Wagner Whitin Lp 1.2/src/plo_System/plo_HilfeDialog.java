...
//*** Konstruktor *************************************************************************************
	public plo_HilfeDialog() {
	   ...
	   // Initialisieren des Referenzobjekts fuer dispose()-Aufrufe
		...
		hilfeLabel10 	= new JLabel("   4.   Jetzt klicken Sie auf Lösung --> Optimale Lösung.");
		hilfeLabel11 	= new JLabel("   5.   Die Lösung mit den optimalen Lossgrössen erscheint.");
		...
		hilfeLabel17 	= new JLabel("   2.   Nun wählen Sie einen Speicherort und bestätigen mit OK.");
		...
		hilfeLabel24	= new JLabel("   2.   Wählen Sie das zu öffnende Modell und bestätigen mit OK.");
