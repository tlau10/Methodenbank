...
/**
 * Ruft den LP Solver auf. Kommunikation erfolgt ueber Input Files und
 * Output Files.
 *
  ...
  */
  public int solve()
  {
    ...
    if (errorcode < 0)
    {
      ...
      _errMsg+= "\r\n->Besitzten sie genuegen Schreib- u. Leserechte?";
      return errorcode;
    }
    ...
    // Den Solver Ausfuehren! (Geht leider nur ueber eine Batchdatei(?))
...
// --------------------------------------------------------------------------
  ...
  private int parseOutFile()
  {
    ...
    {
      _errMsg = fileReader.getErrorMsg();
      _errMsg += "\r\n-> ueberpruefen sie ob alle Pfade richtig gesetzt wurden.";
