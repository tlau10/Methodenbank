...
public abstract class BatchSolver implements IErrorMessage
{
  ...
  /**
  * Stoesst die berechnung des Linearen Gleichungssystems an.
  * @return Fehlercode
  ...
  * die Variablennamen. Der zweite Vektor beinhaltet die zugehoerigen Werte.
  */
  public Vector[] getPrimalResults()
  { Vector[] resultTupel = new Vector[2];
    // Variablen / Loesungen Tupel auslesen...
    if (getParser() != null)
    {
  ...
  */
  ...
  /**
  * Fuegt eine neue LP Zeile in den Eingabepuffer ein. Um den Puffer in die
  ...
  */
  ...
  /**
  * Fuegt ein vom User definiertes LP Model in den Eingabepuffer ein. Um den Puffer in die
  * Eingabedatei zu schreiben muss Methode writeLPModel() verwendet werden.
  ...
  */
  ...
  /**
  * Fuegt ein solverspezifisches LP Model in den Eingabepuffer ein. Um den Puffer in die
  * Eingabedatei zu schreiben muss Methode writeLPModel() verwendet werden.
  ...
  * groesser  0  - Falls Fehlercode 1 -> infeasable problem<br>
  ...
  */
  ...
  {
    // aeltere Ausgagedatei loeschen falls vorhanden..
  ...
  * Ausserdem werden die Ein- und Ausgabedateien hier gespeichert.
