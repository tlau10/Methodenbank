...
//*** Konstruktor *************************************************************************************
	public plo_HilfeDialog() {
	   ...
	   // Initialisieren des Referenzobjekts fuer dispose()-Aufrufe
		...
		hilfeLabel9 	= new JLabel("   3.   Im n�chsten Schritt tippen Sie alle Daten ein.");
		hilfeLabel10 	= new JLabel("   4.   Jetzt klicken Sie auf L�sung --> Optimale L�sung.");
		hilfeLabel11 	= new JLabel("   5.   Die L�sung mit den optimalen Lossgr�ssen erscheint.");
		...
		hilfeLabel17 	= new JLabel("   2.   Nun w�hlen Sie einen Speicherort und best�tigen mit OK.");
		hilfeLabel18 	= new JLabel(" ");
		hilfeLabel19 	= new JLabel("------------------------------------------------------------------------------------------ ");
		hilfeLabel20 	= new JLabel("   Modelle laden");
		hilfeLabel21 	= new JLabel("------------------------------------------------------------------------------------------ ");
		hilfeLabel22 	= new JLabel("   1.   Gespeicherte Modelle k�nnen geladen werden, indem Sie auf ");
		hilfeLabel23 	= new JLabel("          Lagermodell --> Modell laden klicken.");
		hilfeLabel24	= new JLabel("   2.   W�hlen Sie das zu �ffnende Modell und best�tigen mit OK.");
